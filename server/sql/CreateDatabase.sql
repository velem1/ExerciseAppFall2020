...
CREATE TABLE IF NOT EXISTS `Users` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_Users_Types1_idx` (`User_Types` ASC),
...
CREATE TABLE IF NOT EXISTS `ContactMethods` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_ContacMethods_Users_idx` (`User_id` ASC),
...
CREATE TABLE IF NOT EXISTS `ExercisePost` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_ExercisePost_Users1_idx` (`Owner_id` ASC),
...
CREATE TABLE IF NOT EXISTS `Comments` (
  ...
  `Owner_id` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_Comments_ExercisePosts1_idx` (`ExercisePost_id` ASC),
...
INSERT INTO `Types` (`id`, `created_at`, `update_at`, `Name`, `Type_id`) VALUES (DEFAULT, 'Now()', DEFAULT, 'Vinyasa', 7);
INSERT INTO `Types` (`id`, `created_at`, `update_at`, `Name`, `Type_id`) VALUES (DEFAULT, 'Now()', DEFAULT, 'Kundalini', 7);
INSERT INTO `Types` (`id`, `created_at`, `update_at`, `Name`, `Type_id`) VALUES (DEFAULT, 'Now()', DEFAULT, 'Restorative', 7);
INSERT INTO `Types` (`id`, `created_at`, `update_at`, `Name`, `Type_id`) VALUES (DEFAULT, 'Now()', DEFAULT, 'Power', 7);
INSERT INTO `Types` (`id`, `created_at`, `update_at`, `Name`, `Type_id`) VALUES (DEFAULT, 'Now()', DEFAULT, 'General', 7);
INSERT INTO `Types` (`id`, `created_at`, `update_at`, `Name`, `Type_id`) VALUES (DEFAULT, 'Now()', DEFAULT, 'Beginner', 8);
INSERT INTO `Types` (`id`, `created_at`, `update_at`, `Name`, `Type_id`) VALUES (DEFAULT, 'Now()', DEFAULT, 'Beginner-Intermediate', 8);
INSERT INTO `Types` (`id`, `created_at`, `update_at`, `Name`, `Type_id`) VALUES (DEFAULT, 'Now()', DEFAULT, 'Intermediate', 8);
INSERT INTO `Types` (`id`, `created_at`, `update_at`, `Name`, `Type_id`) VALUES (DEFAULT, 'Now()', DEFAULT, 'Intermediate-Advanced', 8);
INSERT INTO `Types` (`id`, `created_at`, `update_at`, `Name`, `Type_id`) VALUES (DEFAULT, 'Now()', DEFAULT, 'Advanced', 8);
